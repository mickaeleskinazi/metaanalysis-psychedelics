...
irritability & NA & NA & (p=0.532)\\
jaw tension & NA & NA & (p=0.120)\\
lack of appetite & (p=0.558) & NA & * (p=0.049)\\
\addlinespace
migraine & NA & (p=0.944) & NA\\
muscle tension & NA & NA & (p=0.241)\\
...
perspiration & (p=0.511) & NA & (p=0.065)\\
restlessness & NA & NA & (p=0.558)\\
rumination & NA & NA & (p=0.633)\\
\addlinespace
sleep disorder & NA & *** (p=<0.001) & (p=0.385)\\
suicidal ideation & NA & (p=0.272) & NA\\
temperature perception disturbances & (p=0.290) & NA & NA\\
thinking abnormal & (p=0.299) & NA & NA\\
weakness & NA & NA & (p=0.837)\\
\addlinespace
