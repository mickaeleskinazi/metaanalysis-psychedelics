...
run_main_analysis <- function(
  ...
  run_window <- function(window_value) {
    ...
    robustness_molecule_linear_vs_spline(
      models_df   = dr_mol$models,
      outfile_csv = file.path(rob_dir, "robustness_linear_vs_spline_by_molecule.csv")
    )
    
    robustness_ae_molecule_linear_vs_spline(
      models_df   = dr_ae$models,
      outfile_csv = file.path(rob_dir, "robustness_linear_vs_spline_by_ae_molecule.csv")
    )
